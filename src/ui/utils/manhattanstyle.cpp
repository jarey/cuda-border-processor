...
ManhattanStylePrivate::ManhattanStylePrivate() :
    lineeditImage(QLatin1String(":/images/inputfield.png")),
    lineeditImage_disabled(QLatin1String(":/images/inputfield_disabled.png")),
    extButtonPixmap(QLatin1String(":/images/extension.png")),
    closeButtonPixmap(QLatin1String(":images/closebutton.png"))
{
}
